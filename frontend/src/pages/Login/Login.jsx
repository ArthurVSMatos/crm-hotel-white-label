    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-[#092B1A] to-gray-200 p-4">
      ...
      <div className="w-full max-w-lg bg-[#0B3B24] border-2 border-amber-500 rounded-2xl p-8 shadow-2xl">
        ...
        <div className="flex flex-col items-center mb-8">
          {/* Tag img para a logo real. O w-48 define a largura (aprox 192px), o h-auto mantém a proporção */}
          <img src={logoImg} alt="Logo DealFlow" className="w-48 h-auto mb-2" /> 
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            <label className="block text-white text-sm mb-1">Email Empresarial <span className="text-red-500">*</span></label>
            <input
              type="text"
              name="email"
              ...
              className={`w-full p-3 rounded-lg bg-white text-gray-900 focus:outline-none focus:ring-2 ${
                errors.email ? "border-2 border-red-500 focus:ring-red-500" : "focus:ring-amber-500"
              }`}
          ...
          <div>
            ...
            {/* Container relativo para posicionar o botão do olho sobre o input */}
            <div className="relative">
              <input
                ...
                className={`w-full p-3 pr-12 rounded-lg bg-white text-gray-900 focus:outline-none focus:ring-2 ${
                  errors.password ? "border-2 border-red-500 focus:ring-red-500" : "focus:ring-amber-500"
                }`}
                placeholder="••••••••"
              />
              
              {/* Botão de Ver Senha (Olho SVG) */}
              <button
                type="button"
