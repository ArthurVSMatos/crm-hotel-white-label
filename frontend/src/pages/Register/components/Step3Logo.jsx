...
export default function Step3Logo({ formData, setFormData, prevStep, handleFinalSubmit }) {
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center pt-4">
        ...
        <button 
          ...
          className="bg-amber-500 hover:bg-amber-600 px-6 py-3 rounded-lg text-[#0B3B24] font-bold transition-colors"
        >
          Configurar Meu Hotel
        </button>
      </div>
    </div>
  );
